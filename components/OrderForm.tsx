    ...
    <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {quantity > 0 ? (
                    <>
                      <button
                        ...
                        className="w-8 h-8 rounded-full bg-gray-200 hover:bg-gray-300 flex items-center justify-center transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                        aria-label={`Decrease quantity of ${getTranslatedMenuItemField(item, 'name', lang)}`}
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => handleQuantityChange(item._id, quantity + 1)}
                        className="w-8 h-8 rounded-full bg-blue-600 text-white hover:bg-blue-700 flex items-center justify-center transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                        aria-label={`Increase quantity of ${getTranslatedMenuItemField(item, 'name', lang)}`}
                      >
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                      aria-label={`Add ${getTranslatedMenuItemField(item, 'name', lang)} to order`}
                    >
                      {t('order', 'addItem')}
                    </button>
                  )}
      ...
      <div className="flex justify-end">
        <button
          ...
          className="px-6 py-3 bg-blue-600 text-white rounded-md font-medium hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-sm hover:shadow-md"
          aria-label={t('order', 'placeOrder')}
        >
          {loading ? (
            <>
              <svg
